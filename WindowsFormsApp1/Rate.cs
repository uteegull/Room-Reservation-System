    ...
    public partial class Rate : Form
    {
        ...
        public void disp_data()
        {
            try
            {
                ...
                MySqlDataAdapter adapter = new MySqlDataAdapter("SELECT * from ratings", connection);
                connection.Open();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "insert into adb.ratings(rate,comment,username) values('" + this.textBox1.Text + "','" + this.textBox2.Text + "','"  + this.textBox3.Text + "');";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //string MyConnection2 = "datasource=localhost;port=3307;username=root;password=12345";
                //This is my insert query in which i am taking input from the user through windows forms  
                string Query = "delete from adb.ratings where username='" + this.textBox3.Text + "';";
                //This is  MySqlConnection here i have created the object and pass my connection string.  
                //MySqlConnection MyConn2 = new MySqlConnection(MyConnection2);
                //This is command class which will handle the query and connection object.  
                MySqlCommand MyCommand2 = new MySqlCommand(Query, Myconnection2);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //string MyConnection2 = "datasource=localhost;port=3307;username=root;password=12345";
                //This is my insert query in which i am taking input from the user through windows forms  
                string Query = "update adb.ratings set rate='" + this.textBox1.Text + "',comment='" + this.textBox2.Text + "',username='" + this.textBox3.Text + "' where username='" + this.textBox3.Text + "';";
                //This is  MySqlConnection here i have created the object and pass my connection string.  
                //MySqlConnection MyConn2 = new MySqlConnection(MyConnection2);
                //This is command class which will handle the query and connection object.  
                MySqlCommand MyCommand2 = new MySqlCommand(Query, Myconnection2);
